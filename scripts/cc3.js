function retour_villes(le_dep)
{
	...
	switch(le_dep)
	{
		...
		chaine_villes = "Mercenaires argent + Odin (sans Deathpool) ▲▲▲|2 attaques suicides et Nightstalkers + Ares [Passif Nv 6] (sans MK) ▲";
		break;
		...
		chaine_villes = "Mercenaires argent + Apo (sans Deathpool) ▲▲";
		break;
		...
		break; /* Orchis */
		case "Astral": 
		chaine_villes = "Mercenaires argent + Doom (sans Deathpool)▲▲▲";
		break; /* Orchis */
